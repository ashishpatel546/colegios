          ...
          <div className="bg-blue-700 p-10 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 mb-10 max-w-sm leading-relaxed">
                Our enthusiastic team from <span className="inline-flex items-center font-bold mx-1 bg-white px-2 py-0.5 rounded text-slate-800"><span className="bg-[#000080] text-white px-1 rounded-sm mr-px">A</span><span className="text-[#000080]">pp</span><span className="text-green-600">Me</span> <span className="ml-1">Soft Pvt Ltd</span></span> is ready to answer all your queries and get you started on your digital journey.
              </p>
